      ...
      items: [
        {
          ...
          description: "Seu primeiro 'laboratório de IA' profissional - como ter uma equipe de cientistas de dados organizando tudo para você",
          price: 1500.00,
          functionality: "Ambiente onde você pode testar, organizar e colocar seus modelos de IA 'em produção' sem bagunça - como ter uma 'fábrica de IA' organizada",
          applicability: "Empresas que querem começar a usar IA de forma séria, mas ainda estão aprendendo - ideal para o primeiro projeto de Machine Learning",
          example: "Criar um sistema que prevê vendas ou detecta fraudes, mantendo tudo organizado e versionado como um código de software",
          characteristics: [
        ...
        },
        {
          ...
          description: "Central de comando completa para IA empresarial - como ter um departamento inteiro de IA funcionando automaticamente",
          price: 5000.00,
          functionality: "Plataforma que gerencia centenas de modelos de IA simultaneamente, desde criação até monitoramento, com governança e auditoria completas",
          applicability: "Grandes empresas que usam IA como parte crítica do negócio - bancos, indústrias, grandes varejistas",
          example: "Gerenciar modelos de detecção de fraude, análise de crédito, otimização de preços - tudo com rastreabilidade e compliance total",
          characteristics: [
        ...
        },
        {
          ...
          description: "Seu próprio 'ChatGPT corporativo' personalizado - como ter um assistente superinteligente que conhece seu negócio",
          price: 3500.00,
          functionality: "Plataforma para criar chatbots inteligentes, gerar conteúdo automaticamente e ter assistentes virtuais que realmente entendem sua empresa",
          applicability: "Empresas que querem chatbots realmente inteligentes, geração automática de textos, ou assistentes virtuais personalizados",
          example: "Chatbot de atendimento que responde perguntas específicas da empresa ou sistema que gera relatórios executivos automaticamente",
          characteristics: [
        ...
        },
        {
          ...
          description: "Sistema de 'visão artificial' para sua empresa - como ter funcionários que nunca se cansam de olhar e analisar imagens 24/7",
          price: 2800.00,
          functionality: "Plataforma que 'ensina' computadores a ver e reconhecer objetos, pessoas, defeitos ou qualquer coisa visual que sua empresa precisa monitorar",
          applicability: "Fábricas que precisam inspecionar produtos, empresas de segurança, varejo que quer analytics de clientes, ou qualquer negócio com câmeras",
          example: "Sistema que detecta defeitos em produtos na linha de produção ou conta quantas pessoas passam em frente à loja e qual o perfil delas",
          characteristics: [
            "Annotation tools",
        ...
        },
        {
          ...
          description: "IA que cria IA para você - como ter um assistente que constrói soluções inteligentes apenas arrastando e soltando dados",
          price: 1800.00,
          functionality: "Sistema que cria modelos de inteligência artificial automaticamente - você só precisa mostrar os dados e dizer o que quer prever",
          applicability: "Empresas que querem usar IA mas não têm cientistas de dados - ideal para quem quer resultados sem complexidade técnica",
          example: "Prever quantos produtos vender no próximo mês ou identificar quais clientes podem cancelar, tudo através de interface visual simples",
          characteristics: [
