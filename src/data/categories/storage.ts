      ...
      items: [
        {
          ...
          description: "O 'Ferrari' dos storages - velocidade extrema para aplicações que não podem esperar nem um milissegundo",
          price: 1.30,
          functionality: "All-flash array com latência sub-milissegundo, throughput sustentado e cache inteligente para máxima performance - é como ter uma pista de Fórmula 1 para seus dados",
          applicability: "Sistemas financeiros onde cada milissegundo vale milhões, games online com milhares de jogadores simultâneos, trading de alta frequência",
          example: "Sistema de trading que processa milhares de operações por segundo ou plataforma de gaming MMO onde lag pode perder clientes",
          characteristics: [
        ...
        },
        {
          ...
          description: "Storage empresarial de alto desempenho - como ter uma equipe de pit stop para seus dados mais importantes",
          price: 1.10,
          functionality: "Storage SSD enterprise com cache otimizado e capacidade de 'turbo boost' para picos de demanda - acelera quando você mais precisa",
          applicability: "Sistemas ERP de grandes empresas, banco de dados Oracle ou SQL Server com muitos usuários simultâneos, analytics em tempo real",
          example: "Sistema SAP de uma multinacional ou banco de dados de e-commerce que não pode ficar lento na Black Friday",
          characteristics: [
        ...
        },
        {
          ...
          description: "O equilíbrio perfeito entre velocidade e investimento - como um carro executivo: confiável, rápido e sem exageros",
          price: 0.80,
          functionality: "Storage SSD premium com performance consistente e confiabilidade empresarial - nunca te deixa na mão quando você mais precisa",
          applicability: "E-commerce médio/grande porte, sistemas corporativos de produção, bancos de dados que atendem centenas de usuários",
          example: "Loja virtual que processa milhares de pedidos por dia ou sistema de gestão usado por toda a empresa",
          characteristics: [
        ...
        },
        {
          ...
          description: "O 'carro do dia a dia' dos storages - atende bem a maioria das necessidades sem gastar além do necessário",
          price: 0.60,
          functionality: "Storage SSD otimizado para workloads empresariais típicos - faz o trabalho bem feito sem recursos que você não vai usar",
          applicability: "Websites corporativos, sistemas de gestão departamentais, aplicações internas de médio porte",
          example: "Sistema de gestão usado por 50-100 pessoas ou website corporativo com tráfego moderado mas estável",
          characteristics: [
        ...
        },
        {
          ...
          description: "Storage confiável e econômico - como um carro popular: leva você onde precisa sem luxos desnecessários",
          price: 0.35,
          functionality: "Storage SATA SSD com performance adequada para aplicações básicas e ambientes de teste - simples, eficiente e econômico",
          applicability: "Ambientes de desenvolvimento e teste, file servers departamentais, sites institucionais, sistemas internos simples",
          example: "Ambiente onde a equipe de desenvolvimento testa aplicações ou servidor de arquivos do departamento financeiro",
          characteristics: [
